...
<head>
    ...
    <title>S.G.P.O - Sistema de Gestão Produto Oficial .NET</title>
</head>
...
<body class="sb-nav-fixed">
    ...
    <nav class="sb-topnav navbar navbar-expand navbar-dark" style="background-color: black;">
        <!-- Navbar Brand-->
        <a class="navbar-brand ps-3" href="index.html"><b>S.G.P.O</b></a>
        <!-- Sidebar Toggle-->
            ...
            <nav class="sb-sidenav accordion sb-sidenav-five" id="sidenavAccordion">
                <div class="sb-sidenav-menu">
                    <div class="nav">
                        ...
                        <a @class(['nav-link', 'active' => isset($menu) && $menu == 'usuarios']) class="nav-link" href="#">
                            <div class="sb-nav-link-icon"><i class="fa-solid fa-users"></i></i></div>
                            Usuários
                        </a>

                        <a @class(['nav-link', 'active' => isset($menu) && $menu == 'papeis']) class="nav-link" href="#">
                        ...
                        <a @class([
                            'nav-link',
                            'active' => isset($menu) && $menu == 'permissoes',
                        ]) class="nav-link" href="#">
            ...
            <footer class="py-4 bg-light mt-auto">
                <div class="container-fluid px-4">
                    <div class="d-flex align-items-center justify-content-between small">
                        <div class="text-muted">Copyright &copy; S.G.P.O {{ date('Y') }}
                        </div>
                    </div>
                </div>
            </footer>
